...
@Component({
  ...
  imports: [RouterOutlet, HeaderComponent, UserComponent, TasksComponent, NewTaskComponent], // Importing those components which are used in this component
...
export class AppComponent {
  ...
  onAddTask(buttonClicked: boolean) {
    if (this.addTaskClicked) {
      this.addTaskClicked = !buttonClicked;
    } else {
      this.addTaskClicked = buttonClicked;
    }
  }
